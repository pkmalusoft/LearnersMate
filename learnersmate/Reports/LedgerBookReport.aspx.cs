    ...
    public partial class LedgerBookReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/ledgerbook.rdl");                
                DataTable dt = GetData("SELECT *  FROM [dbo].[smsLedgerBooks] Where UserID = '" + userid  + "' Order by LedgerBookID");
