    ...
    public partial class TrialBalanceReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/trialbalance.rdl");                
                DataTable dt = GetData("SELECT *  FROM [dbo].[smsTrialBalances] Where UserID = '" + userid  + "' Order by TrialBalanceID");
